...
function Experiences() {
  return (
    <div className="min-h-[100vh] pt-[100px] pb-[100px] pr-[15px] pl-[15px] text-white">
      ...
      <div className="max-w-[1200px] m-auto flex flex-wrap relative">
        {/* <div className="absolute w-[2px] h-[100%] bg-white sm:left-[calc(50%-1px)] left-[7px] mt-5"></div> */}
        {/* item1 */}
        <VerticalTimeline>
          {ORGANIZATION.map((data) => (
            <VerticalTimelineElement key={data.key} date={data.year}>
              ...
              <div className="content drop-shadow-md h-full p-[24px]  rounded-3xl sm:mt-[15px] mt-[0px] mr-4 sm:mr-0 bg-gradient-to-b from-slate-300/10 border-[0.5px] border-slate-500/50 backdrop-filter backdrop-blur-4xl   ">
