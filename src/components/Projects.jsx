    ...
    <div className="flex flex-col max-w-[1150px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 max-w-[1350px] mx-auto mb-8 md:mb-12 md:mt-8 mt-6 ml-6 mr-6">
        ...
        {PROJECTS.map((project, index) => (
          <div
            key={index}
            className="md:h-[600px] m-auto w-[95%] mb-8 sm:rounded-[48px] rounded-[36px]  bg-gradient-to-b from-slate-300/10 border-[0.5px] border-slate-500/50 backdrop-filter backdrop-blur-4xl flex place-content-center"
          >
            <div className="p-4 sm:p-6 flex flex-col">
              ...
              <div>
                ...
                <div className="w-52 flex mt-8 pl-3 pr-3 pt-2 pb-2 mr-3 text-xl rounded-2xl  border-[0.5px] border-slate-100/50 bg-white/5">
