  ...
  return (
    <div className="flex flex-col max-w-[1350px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 max-w-[1350px] mx-auto mb-8 md:mb-12 md:mt-8 mt-6 ml-6 mr-6">
        {/* card */}
        <div className="md:h-[600px] m-auto w-[95%] mb-8 rounded-[48px]  bg-gradient-to-b from-slate-300/10 border-[0.5px] border-slate-500/50 backdrop-filter backdrop-blur-4xl flex place-content-center">
          <div className="p-6 flex flex-col">
            <img
              className="rounded-3xl overflow-hidden w-full md:h-72 h-40 object-cover"
              src={portofolio1}
              alt=""
            />
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-br from-white to-neutral-800 md:text-l text-sm ">
              ...
              Laudantium doloribus cum reiciendis laboriosam assumenda incidunt
            </span>
            <div>
              <div className="inline-block mt-4 pl-3 pr-3 pt-2 pb-2 mr-3 md:text-base text-sm rounded-xl   border-[0.5px] border-slate-100/50 backdrop-filter backdrop-blur-4xl text-transparent bg-clip-text bg-gradient-to-br from-white to-neutral-800 hover:scale-[1.1]">
                ReactJS
              </div>
              <div className="inline-block mt-4 pl-3 pr-3 pt-2 pb-2 mr-3 md:text-base text-sm rounded-xl   border-[0.5px] border-slate-100/50 backdrop-filter backdrop-blur-4xl text-transparent bg-clip-text bg-gradient-to-br from-white to-neutral-800 hover:scale-[1.1]">
                Tailwind
