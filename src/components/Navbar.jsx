...
function Navbar() {
  ...
  return (
    <div className="flex justify-center items-center w-full">
      <div
        className="fixed sm:top-6 top-0 z-[999] sm:w-[80%] w-[100%] flex text-xl justify-between text-slate-700 items-center px-12 h-[80px]
        bg-gradient-to-t from-indigo-100/10 border-b-[1px] sm:border-[0.5px] sm:rounded-[36px] rounded-none border-blue-200/50 backdrop-filter backdrop-blur-3xl drop-shadow-3xl"
      >
        ...
        <div
          className={
            nav
              ? "text-center z-20 fixed h-120 pb-10 w-full left-0 top-0  bg-indigo-950/95 backdrop-filter backdrop-blur-4lg border-b-[1px] border-white "
              : "fixed left-[-100%]"
          }
        >
